...
/**
 * Admin quotation management hook: list/load/create/update quotations.
 * Authorization (who can see/edit which quotation) is enforced
 * server-side on every call — this hook only shapes requests and holds
 * UI state.
 */
